...
public class ApothicAttributesHelper {
    ...
    private static CritAttributeData getAttributeData(LivingEntity living, String attributeId) {
        try {
            ResourceLocation location = ResourceLocation.parse(attributeId);
            ...
            ResourceLocation damageLocation = ResourceLocation.parse(damageAttributeId);
            Attribute damageAttribute = BuiltInRegistries.ATTRIBUTE.get(damageLocation);
