...
public class GunsmithLibHelper {
   ...
   public static double evaluateAttribute(ItemStack gunItem, Supplier<Attribute> attributeSupplier, double baseValue) {
      return IS_GUNSMITHLIB_LOADED && gunItem != null && !gunItem.isEmpty() ? GsHelper.evaluateItemAttribute(gunItem, BuiltInRegistries.ATTRIBUTE.wrapAsHolder(attributeSupplier.get()), baseValue) : baseValue;
   }
